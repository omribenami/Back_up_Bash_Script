...
sudo tar  --exclude='*.db' -cvzf  "1stwom_backup.tar.gz" ~/{bin,homeassistant,docker}  # enter any directory you like to add to your backup file, HA database is excluded to reduce file size (--exclude='*.db')
